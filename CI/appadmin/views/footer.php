...
<script src='/plugins/bower_components/fullcalendar/dist/fullcalendar.min.js'></script>
<!-- data table plugin -->
<script src='/plugins/js/jquery.dataTables.min.js'></script>

<!-- select or dropdown enhancer -->
<script src="/plugins/bower_components/chosen/chosen.jquery.min.js"></script>
<!-- plugin for gallery image view -->
<script src="/plugins/bower_components/colorbox/jquery.colorbox-min.js"></script>
<!-- notification plugin -->
<script src="/plugins/js/jquery.noty.js"></script>
<!-- library for making tables responsive -->
<script src="/plugins/bower_components/responsive-tables/responsive-tables.js"></script>
<!-- tour plugin -->
<script src="/plugins/bower_components/bootstrap-tour/build/js/bootstrap-tour.min.js"></script>
<!-- star rating plugin -->
<script src="/plugins/js/jquery.raty.min.js"></script>
...
<script src="/plugins/js/jquery.uploadify-3.1.min.js"></script>
