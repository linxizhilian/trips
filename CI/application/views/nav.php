<header id="homepage-header" class="header">
	<div class="header-logo">
		<a class="header-link" href="/">
			<div class="js-logo-container black">
				<img src="/plugins/assets/images/logo.png" alt="...">
			</div>
		</a>
	</div>
...
<!--					<a href="/Category/index"></a>-->
	...
	<div class="header-contact">
		<p>Wechat: 86-18551151099</p>
		<p>Email: book@catherinelutours.com</p>
	</div>

	<div class="menu-group-btn menu-group">
